...
export function getItemType(item: { market_group_id?: number }) {
  ...
  switch (item.market_group_id) {
    // Pilot Service
    case 300000000:
      return itemCategory.plex;
    case 300001000:
      return itemCategory.skillChip;
    // Ships
    case 100000000:
      return itemCategory.basicFrigate;
    case 100000002:
      return itemCategory.frigate;
    case 100000004:
      return itemCategory.interceptor;
    case 100000006:
      return itemCategory.assaultFrigate;
    case 100000008:
      return itemCategory.covertOpsFrigate;
    case 100000010:
      return itemCategory.stealthBomber;
    case 100000014:
      return itemCategory.logisticsFrigate;
    case 100001000:
      return itemCategory.destroyer;
    case 100001004:
      return itemCategory.commandDestroyer;
    case 100001006:
      return itemCategory.tacticalDestroyer;
    case 100002000:
      return itemCategory.cruiser;
    case 100002004:
      return itemCategory.forceRecon;
    case 100002006:
      return itemCategory.heavyAssaultCruiser;
    case 100003000:
      return itemCategory.battlecruiser;
    case 100003002:
      return itemCategory.assaultBattlecruiser;
    case 100003006:
      return itemCategory.logisticsBattlecruiser;
    case 100003008:
      return itemCategory.forceFieldBattlecruiser;
    case 100004000:
      return itemCategory.transportShip;
    case 100004002:
      return itemCategory.expeditionFrigate;
    case 100004004:
      return itemCategory.miningBarge;
    case 100005000:
      return itemCategory.battleship;
    // Modules - High
    case 101000000:
      return itemCategory.smallPulseLaser;
  }
...
export function getEHP(item: Item) {
  return Math.ceil(
    item.attributes[Attributes.shieldCapacity].value /
      (1 -
        Math.min(
          item.attributes[Attributes.shieldEmDamageResonance].value,
          item.attributes[Attributes.shieldExplosiveDamageResonance].value,
          item.attributes[Attributes.shieldKineticDamageResonance].value,
          item.attributes[Attributes.shieldThermalDamageResonance].value
        )) +
      item.attributes[Attributes.armorHP].value /
        (1 -
          Math.min(
            item.attributes[Attributes.armorEmDamageResonance].value,
            item.attributes[Attributes.armorExplosiveDamageResonance].value,
            item.attributes[Attributes.armorKineticDamageResonance].value,
            item.attributes[Attributes.armorThermalDamageResonance].value
          )) +
      item.attributes[Attributes.hp].value /
        (1 -
          Math.min(
            item.attributes[Attributes.emDamageResonance].value,
            item.attributes[Attributes.explosiveDamageResonance].value,
            item.attributes[Attributes.kineticDamageResonance].value,
            item.attributes[Attributes.thermalDamageResonance].value
          ))
  );
}
